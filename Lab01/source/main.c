...
static void fail_unknown_pipeline_algorithm(const char *exec_name,
                                            const char *arg) {
...
__attribute__((weak)) int pipeline_serial(image_dir_t *image_dir) { return -1; }

__attribute__((weak)) int pipeline_pthread(image_dir_t *image_dir) {
  return -1;
}

__attribute__((weak)) int pipeline_tbb(image_dir_t *image_dir) { return -1; }
